...
//        EMClient.getInstance().chatManager().getSubscribedUserList(new EMCallBack() {
//            @Override
//            public void onSuccess() {
//                EMLog.d(TAG, "getSubscribedUserList onSuccess");
//            }
//
//            @Override
//            public void onError(int code, String error) {
//                EMLog.d(TAG, "getSubscribedUserList onError:" + code + ",error=" + error);
//            }
//
//            @Override
//            public void onProgress(int progress, String status) {
